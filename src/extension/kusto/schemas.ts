...
// import { fromConnectionInfo } from './connections';
...
// export async function getClusterSchema(connection: IConnectionInfo, ignoreCache?: boolean): Promise<EngineSchema> {
//     const key = `${GlobalMementoKeys.prefixForClusterSchema}:${connection.id.toLowerCase()}`;
...
//                 try {
//                     if (connection.type !== 'azAuth') {
//                         return {
//                             cluster: { connectionString: '', databases: [] },
//                             clusterType: 'Engine',
//                             database: undefined
//                         } as EngineSchema;
//                     }
...
//                             getDatabaseSchema(client, { ...connection, database: database }, ignoreCache)
//                         )
//                     );
